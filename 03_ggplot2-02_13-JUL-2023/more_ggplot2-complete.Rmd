...
📣 Create a box plot to show the distributions of the monthly number of trips from Paris-Gare-de-Lyon for each international destination:
...
📣 Add text to provide additional information about the data being displayed:
...
📣 Change elements that are specified in `theme()`
